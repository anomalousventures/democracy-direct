...
- [x] Features grouped by status (Now Building, Up Next, Planned, Completed)
...
- [x] GitHub Discussions enabled with "Feature Requests" category
- [x] "Suggest a feature" link works and goes to Discussions
